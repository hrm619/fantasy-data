...
class TestEnsurePlayerExists:
    def test_creates_new_player(self, session):
        player = ensure_player_exists(session, "TestPl01", "Test Player", "WR", "KC", gsis_id="00-001")
    ...
    def test_returns_existing_player(self, session, seed_players):
        player = ensure_player_exists(session, "MahomPa01", "Patrick Mahomes", "QB", "KC", gsis_id="00-999")
