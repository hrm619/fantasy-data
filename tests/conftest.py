...
def seed_coaching(session):
    ...
    staff = [
        ...
        CoachingStaff(
            ...
            offensive_coordinator="Frank Smith",
            hc_continuity_flag=1,
        ...
        CoachingStaff(
            ...
            offensive_coordinator="Zac Robinson",
            hc_continuity_flag=1,
            oc_continuity_flag=1,
            qb_continuity_flag=1,
            hc_year_with_team=2,
...
def seed_baselines(session, seed_players):
    ...
    baselines = [
        PlayerSeasonBaseline(
            ...
            target_share=0.0,
            air_yards_share=0.0,
            fantasy_pts_ppr=350.0,
            fpts_per_game_ppr=20.6,
            adp_consensus=2.5,
            adp_positional_rank=1,
            rankings_fpts_positional=1,
            rankings_jj_positional=2,
            rankings_hw_positional=1,
            rankings_pff_positional=2,
            rankings_ds_positional=1,
            rankings_source_count=5,
        ),
        PlayerSeasonBaseline(
            baseline_id="HillTy01_2024",
            player_id="HillTy01",
            season=2024,
            team="MIA",
            games_played=16,
            ...
            fantasy_pts_ppr=280.0,
            fpts_per_game_ppr=17.5,
            adp_consensus=15.0,
            adp_positional_rank=5,
            rankings_fpts_positional=3,
            rankings_jj_positional=4,
            rankings_hw_positional=2,
            rankings_pff_positional=3,
            rankings_ds_positional=8,
            rankings_source_count=5,
        ),
        PlayerSeasonBaseline(
            baseline_id="ChasJa01_2024",
            player_id="ChasJa01",
            season=2024,
            team="CIN",
            games_played=17,
            ...
            fantasy_pts_ppr=310.0,
            fpts_per_game_ppr=18.2,
            adp_consensus=8.0,
            adp_positional_rank=3,
            rankings_fpts_positional=1,
            rankings_jj_positional=1,
            rankings_hw_positional=1,
            rankings_pff_positional=2,
            rankings_ds_positional=2,
            rankings_source_count=5,
        ),
        PlayerSeasonBaseline(
            baseline_id="RobiBi01_2024",
            player_id="RobiBi01",
            season=2024,
            team="ATL",
            games_played=17,
            snap_share=0.82,
            target_share=0.10,
            carries_per_game=18.5,
            fantasy_pts_ppr=290.0,
            fpts_per_game_ppr=17.1,
            adp_consensus=4.0,
            adp_positional_rank=1,
            rankings_fpts_positional=2,
            rankings_jj_positional=1,
            rankings_hw_positional=1,
            rankings_pff_positional=1,
            rankings_ds_positional=3,
            rankings_source_count=5,
        ),
        PlayerSeasonBaseline(
            baseline_id="WillCa01_2024",
            player_id="WillCa01",
            season=2024,
            team="CHI",
            games_played=17,
            snap_share=0.99,
            adp_consensus=45.0,
            adp_positional_rank=8,
            rankings_fpts_positional=5,
            rankings_jj_positional=6,
            rankings_hw_positional=4,
            rankings_pff_positional=7,
            rankings_ds_positional=10,
            rankings_source_count=5,
        ),
    ]
