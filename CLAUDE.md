...
- **Whether play-caller beats OC title for the decay is untested**: it is a better *description* of scheme disruption, but that it predicts outcome variance better is a hypothesis, not a finding. It is backtestable against 2014-2025 once historical play-caller data exists.
